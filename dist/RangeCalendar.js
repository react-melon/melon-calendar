...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-core/Validity', 'melon-core/classname/cxBuilder', 'melon-core/InputComponent', 'melon-core/util/syncPropsToState', 'melon/Icon', 'melon/Confirm', './Calendar', './calendar/Panel', './util/date', "./babelHelpers"], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-core/Validity'), require('melon-core/classname/cxBuilder'), require('melon-core/InputComponent'), require('melon-core/util/syncPropsToState'), require('melon/Icon'), require('melon/Confirm'), require('./Calendar'), require('./calendar/Panel'), require('./util/date'), require("./babelHelpers"));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.Validity, global.cxBuilder, global.InputComponent, global.syncPropsToState, global.Icon, global.Confirm, global.Calendar, global.Panel, global.date, global.babelHelpers);
        global.RangeCalendar = mod.exports;
    }
})(this, function (exports, _react, _Validity, _cxBuilder, _InputComponent2, _syncPropsToState, _Icon, _Confirm, _Calendar, _Panel, _date, babelHelpers) {
    'use strict';
