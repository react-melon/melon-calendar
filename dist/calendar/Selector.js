...
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'react-dom', 'melon-core/classname/cxBuilder', './SelectorItem', '../util/date', 'melon-core/util/array', "../babelHelpers"], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('react-dom'), require('melon-core/classname/cxBuilder'), require('./SelectorItem'), require('../util/date'), require('melon-core/util/array'), require("../babelHelpers"));
    } else {
        var mod = {
            exports: {}
        };
